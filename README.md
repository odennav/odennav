...
<img src="https://github.com/devicons/devicon/blob/master/icons/consul/consul-original-wordmark.svg" title="Consul" alt="Consul" width="40" height="40"/>&nbsp; 
  ...
  <img src="https://github.com/odennav/odennav/blob/main/docs/elastic.svg" title="ELASTIC" alt="ELASTIC" style="width: 80px; height: 45px; transform: scale(4.0);"/>&nbsp;
   <img src="https://github.com/devicons/devicon/blob/master/icons/opentelemetry/opentelemetry-original.svg" title="OpenTelemetry" alt="OpenTelemetry" style="width: 50px; height: 45px; transform: scale(4.0);"/>&nbsp; 
