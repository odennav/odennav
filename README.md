...
<div>
  ...
  <img src="https://github.com/odennav/odennav/blob/main/docs/traefikproxy-original-wordmark.svg" title="Traefik" **alt="Traefik" style="width: 80px; height: 45px; transform: scale(4.0);"/>&nbsp;
  ...
  <img src="https://github.com/odennav/odennav/blob/main/docs/argocd-original-wordmark.svg" title="ARGOCD" alt="ARGOCD" style="width: 80px; height: 45px; transform: scale(4.0);"/>&nbsp;
